...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.PotentiostatFile_label = QtWidgets.QLabel(self.groupBox_2)
        self.PotentiostatFile_label.setText("")
        self.PotentiostatFile_label.setObjectName("PotentiostatFile_label")
        self.horizontalLayout_2.addWidget(self.PotentiostatFile_label)
        self.PotentiostatFile_button = QtWidgets.QPushButton(self.groupBox_2)
        self.PotentiostatFile_button.setMaximumSize(QtCore.QSize(75, 16777215))
        self.PotentiostatFile_button.setObjectName("PotentiostatFile_button")
        self.horizontalLayout_2.addWidget(self.PotentiostatFile_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Select Potentiostat .txt File"))
        self.label_3.setText(_translate("MainWindow", "File:"))
        self.PotentiostatFile_button.setText(_translate("MainWindow", "Browse"))
